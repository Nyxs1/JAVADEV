                ...
                <button id="scroll-down-btn" onclick="scrollToNextSection()"
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <img src="<?php echo e(asset('assets/icons/arrow-down-icon.svg')); ?>" alt="Scroll Down"
    ...
    <div class="lp-container">
        ...
        <div class="grid lg:grid-cols-2 items-start gap-10 lg:gap-24">
            <div class="animate-on-scroll">
                <img src="<?php echo e(asset('assets/images/photos/Who We Are.png')); ?>" alt="JavaDev Team"
        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="relative group cursor-pointer animate-on-scroll card-hover-container">
                <div class="relative overflow-hidden shadow-lg card-inner">
                    <img src="<?php echo e(asset('assets/images/photos/profesional.png')); ?>" alt="Mentor"
                        class="w-full h-80 object-cover card-image">

                    <div class="card-badge">
                        <div class="badge-inner">
                            <img src="<?php echo e(asset('assets/images/stickers/Professional 1.png')); ?>" alt="Mentor Icon"
            ...
            <div class="relative group cursor-pointer animate-on-scroll card-hover-container">
                <div class="relative overflow-hidden shadow-lg card-inner">
                    <img src="<?php echo e(asset('assets/images/photos/student.png')); ?>" alt="Mahasiswa"
                        class="w-full h-80 object-cover card-image">

                    <div class="card-badge">
                        <div class="badge-inner">
                            <img src="<?php echo e(asset('assets/images/stickers/Freshgraduate 1.png')); ?>" alt="Mahasiswa Icon"
                                class="w-8 h-8 rounded-full">
                            <span>Mahasiswa</span>
                        </div>
                    </div>
    ...
    <div class="lp-container">
        <div class="tools-wrap">
            ...
            <div class="tools-grid">
                <div class="tool-item">
                    <img src="<?php echo e(asset('assets/tech-logos/logos_css-3.png')); ?>" alt="CSS">
                    <span>CSS</span>
                </div>

                <div class="tool-item">
                    <img src="<?php echo e(asset('assets/tech-logos/logos_bootstrap.png')); ?>" alt="Bootstrap">
                    <span>Bootstrap</span>
                </div>

                <div class="tool-item">
                    <img src="<?php echo e(asset('assets/tech-logos/logos_nextjs.png')); ?>" alt="Next Js">
                    <span>Next Js</span>
                </div>

                <div class="tool-item">
                    <img src="<?php echo e(asset('assets/tech-logos/logos_php.png')); ?>" alt="PHP">
                    <span>PHP</span>
                </div>

                <div class="tool-item">
                    <img src="<?php echo e(asset('assets/tech-logos/logos_go.png')); ?>" alt="Golang">
                    <span>Golang</span>
                </div>

                <div class="tool-item">
                    <img src="<?php echo e(asset('assets/tech-logos/logos_javascript.png')); ?>" alt="Javascript">
                    <span>Javascript</span>
                </div>

                <div class="tool-item">
                    <img src="<?php echo e(asset('assets/tech-logos/logos_figma.png')); ?>" alt="Figma">
                    <span>Figma</span>
                </div>

                <div class="tool-item">
                    <img src="<?php echo e(asset('assets/tech-logos/logos_nodejs.png')); ?>" alt="Node Js">
                    <span>Node Js</span>
                </div>

                <div class="tool-item">
                    <img src="<?php echo e(asset('assets/tech-logos/logos_adobe-illustrator.png')); ?>" alt="Adobe Illustrator">
                    <span>Adobe Illustrator</span>
                </div>

                <div class="tool-item">
                    <img src="<?php echo e(asset('assets/tech-logos/logos_adobe-photoshop.png')); ?>" alt="Adobe Photoshop">
                    <span>Adobe Photoshop</span>
                </div>

                <div class="tool-item">
                    <img src="<?php echo e(asset('assets/tech-logos/logos_laravel.png')); ?>" alt="Laravel">
                    <span>Laravel</span>
                </div>

                <div class="tool-item">
                    <img src="<?php echo e(asset('assets/tech-logos/logos_java.png')); ?>" alt="Java">
                    <span>Java</span>
                </div>
            </div>
        ...
        <div class="achievement-gallery">
            ...
            <div class="achievement-item">
                <div class="achievement-image">
                    <img src="<?php echo e(asset('assets/images/photos/Juara.png')); ?>" alt="Juara 1 Hackathon 2024">
                </div>
            ...
            <div class="achievement-item">
                <div class="achievement-image">
                    <img src="<?php echo e(asset('assets/images/photos/Juara.png')); ?>" alt="Best Innovation Award">
                </div>
                <div class="achievement-content">
            ...
            <div class="achievement-item">
                <div class="achievement-image">
                    <img src="<?php echo e(asset('assets/images/photos/Juara.png')); ?>" alt="Tech Conference Speaker">
                </div>
                <div class="achievement-content">
            ...
            <div class="achievement-item">
                <div class="achievement-image">
                    <img src="<?php echo e(asset('assets/images/photos/Juara.png')); ?>" alt="Startup Competition Winner">
                </div>
                <div class="achievement-content">
            ...
            <div class="achievement-item">
                <div class="achievement-image">
                    <img src="<?php echo e(asset('assets/images/photos/Juara.png')); ?>" alt="Community Impact Award">
                </div>
                <div class="achievement-content">
            ...
            <div class="achievement-item">
                <div class="achievement-image">
                    <img src="<?php echo e(asset('assets/images/photos/Juara.png')); ?>" alt="Open Source Contributor">
                </div>
                <div class="achievement-content">
        ...
        <div class="courses-grid">
            ...
            <div class="course-card">
                <div class="course-icon">
                    <img src="<?php echo e(asset('assets/icons/project-manager-icon.svg')); ?>" alt="Project Manager">
                </div>
            ...
            <div class="course-card">
                <div class="course-icon">
                    <img src="<?php echo e(asset('assets/icons/vibe-code-icon.svg')); ?>" alt="Vibe Code">
                </div>
                <h3>Vibe Code</h3>
            ...
            <div class="course-card">
                <div class="course-icon">
                    <img src="<?php echo e(asset('assets/icons/uiux-design-icon.svg')); ?>" alt="UI/UX Design">
                </div>
                <h3>UI/UX Design</h3>
            ...
            <div class="course-card">
                <div class="course-icon">
                    <img src="<?php echo e(asset('assets/icons/mobile-code-icon.svg')); ?>" alt="Mobile Code">
                </div>
                <h3>Mobile Code</h3>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12 events-cards-grid">
            ...
            <div
                ...
                <div class="h-48 overflow-hidden">
                    <img src="<?php echo e(asset('assets/images/photos/Who We Are.png')); ?>" alt="Kelas UI/UX Design"
            ...
            <div
                class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 animate-on-scroll event-card">
                <div class="h-48 overflow-hidden">
                    <img src="<?php echo e(asset('assets/images/photos/profesional.png')); ?>" alt="Vibe Code With Framer"
                        class="w-full h-full object-cover">
                </div>
                <div class="p-6">
            ...
            <div
                class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 animate-on-scroll event-card">
                <div class="h-48 overflow-hidden">
                    <img src="<?php echo e(asset('assets/images/photos/student.png')); ?>" alt="Build Website From Scratch"
                        class="w-full h-full object-cover">
                </div>
                <div class="p-6">
            ...
            <div
                class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 animate-on-scroll event-card">
                <div class="h-48 overflow-hidden">
                    <img src="<?php echo e(asset('assets/images/photos/Who We Are.png')); ?>" alt="Build Apps With Kotlin"
                        class="w-full h-full object-cover">
                </div>
                <div class="p-6">
            ...
            <div
                class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 animate-on-scroll event-card">
                <div class="h-48 overflow-hidden">
                    <img src="<?php echo e(asset('assets/images/photos/profesional.png')); ?>" alt="How To Start Data Analys"
                        class="w-full h-full object-cover">
                </div>
                <div class="p-6">
            ...
            <div
                class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 animate-on-scroll event-card">
                <div class="h-48 overflow-hidden">
                    <img src="<?php echo e(asset('assets/images/photos/student.png')); ?>" alt="Ethical Hacker : Penetration..."
                        class="w-full h-full object-cover">
                </div>
                <div class="p-6">
...
<section id="requirements" class="relative py-20 overflow-hidden">
    ...
    <div class="absolute inset-0">
        <img src="<?php echo e(asset('assets/images/photos/Who We Are 1.png')); ?>" alt="Join Us Background"
            class="w-full h-full object-cover">
...
</section><?php /**PATH C:\laragon\www\JAVADEV\resources\views/pages/landingpage.blade.php ENDPATH**/ ?>